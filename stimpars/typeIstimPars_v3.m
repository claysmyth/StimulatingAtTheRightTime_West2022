...
R.IntP.phaseStim.trackdelay = 25/1000; %  his is the delay to take the signal (current tstep-delay)
R.IntP.phaseStim.upperiod = 25/1000; % update period
R.IntP.phaseStim.stimlength = R.IntP.phaseStim.upperiod; % stim delivery
